		...
		<div class="rounded-xl border border-gray-200 p-4">
			...
			<div class:hidden={lang !== 'nl'} class="space-y-4">
				...
				<div>
					...
					<textarea id="nl_content" name="nl_content" rows="10" class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm focus:border-crf-blue focus:outline-none focus:ring-1 focus:ring-crf-blue"></textarea>
				</div>
			</div>
			...
			<div class:hidden={lang !== 'pap'} class="space-y-4">
				...
				<div>
					...
					<textarea id="pap_content" name="pap_content" rows="10" class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm focus:border-crf-blue focus:outline-none focus:ring-1 focus:ring-crf-blue"></textarea>
				</div>
			</div>
		</div>
